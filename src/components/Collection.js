    ...
    return (
        <Row>
          ...
          <Col xs={10}>
            ...
            {this.props.collectionStore.createDisplayName(
              this.props.params.collectionname)}
              collection: {this.props.userStore.getPercentageCompletion(
                this.props.params.collectionname).toFixed(0)}%
            </h3>
            <ProgressBar
              active striped
              bsStyle="success"
              key="1"
              style={{border: ".5px solid #57ae81", background: "white"}}
              now={parseInt(
                this.props.userStore.getPercentageCompletion(
                  this.props.params.collectionname).toFixed(0))
              }
            />
          </Col>
